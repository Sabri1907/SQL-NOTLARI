...
SELECT * FROM  kisiler;
--kisiler tablosunu adrese göre sıralayarak sorgulayınız
select * from kisiler ORDER BY adres;
select * from kisiler ORDER BY adres asc; --ASCENDING (ASC) YAZMASAKTA SIRALI VERİR
--kisiler tablosunu adrese göre TERSTEN sıralayarak sorgulayınız
select * from kisiler ORDER BY adres desc; --tersten sıralama
--kisiler tablosunda maas'ı buyukten kucuge sıralayınız
